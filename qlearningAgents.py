...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        "*** YOUR CODE HERE ***"
        self.q_values = {} #{ (state, action): Q(state, action) }
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        "*** YOUR CODE HERE ***"
        sample_q_value = reward + self.discount * self.computeValueFromQValues(nextState)
        current_qv = self.getQValue(state, action)
        difference = sample_q_value - current_qv
        self.q_values[(state, action)] = current_qv + self.alpha * difference
